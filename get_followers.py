...
options.add_extension("/Users/gyanprakash/Downloads/intagram_bis/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/gyanprakash/Downloads/{}_followers.csv /Users/gyanprakash/Downloads/intagram_bis/accounts'.format(account))
        except:
